...
namespace App\Infrastructure\CrowdsecService;
...
class Settings
{
    ...
    public function __construct(string $dir,array $context)
    {
        $this->dir = $dir."/../";
    ...
    public function settings()
    {
        return [
             ...
             */
            'log_directory_path' => $this->dir."/var/.crowdesc",
             ...
             */
            'api_key' => $this->context['CROWDSEC_API_KEY'],
            ...
            'redis_dsn' => $this->context['REDIS_URL'],
            ...
            'geolocation' => [
                ...
                'maxmind' => [
                    ...
                    // Important note: be sure this path won't be publicly accessible
                    'database_path' => $this->dir."/var/GeoLite2-Country.mmdb",
                ],
            ]
        ];
    }
